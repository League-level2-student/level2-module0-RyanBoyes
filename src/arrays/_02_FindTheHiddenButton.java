...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String Str = JOptionPane.showInputDialog("Enter a positive number.");
		int convert = Integer.parseInt(Str);
		//4. Initialize the array of JButtons to be the size of the int created in step 3
		buttons = new JButton[convert];
		...
		Random randy = new Random();
		 hiddenButton = randy.nextInt(convert);
	...
	public void actionPerformed(ActionEvent e) {
		...
		//17. if the hiddenButton is clicked, tell the user that they win.
			...
			if(e.getSource() == buttons[hiddenButton]) {
				JOptionPane.showMessageDialog(null, "Congradulations, you found the hidden button!");
			}
			else {
